...
export type Bookshelf = {
  books?: Maybe<Array<Maybe<Bookshelf_Book>>>;
};

export type Bookshelf_Book = {
  id: Scalars['ID'];
  url: Scalars['String'];
  year: Scalars['Int'];
  review?: Maybe<Scalars['String']>;
  level: Bookshelf_Level;
  user: Bookshelf_User;
};

export type Bookshelf_Level = 
  | 'BEGINNER'
  | 'INTERMEDIATE'
  | 'EXPERT';

export type Bookshelf_NewBook = {
  url: Scalars['String'];
  year: Scalars['Int'];
  review?: Maybe<Scalars['String']>;
  level: Bookshelf_Level;
...
export type Bookshelf_NewUser = {
  name: Scalars['String'];
};

export type Bookshelf_User = {
  id: Scalars['ID'];
  name: Scalars['String'];
};
